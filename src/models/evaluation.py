...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='Deepakscripts', 
             repo_name='swiggy_deliveryTime_prediction', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/Deepakscripts/swiggy_deliveryTime_prediction.mlflow")
